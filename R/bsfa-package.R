...
#'
#' Koop, G. (2003). \emph{Bayesian Econometrics}. Chichester: Wiley.
#'
...
# The stats generics are imported rather than merely called, because a
# namespace that registers an S3 method for one of them has to be able to find
# it when it loads with only base attached.
